...
function run(request, { title = '[build] dev/260808_2242/test/Generic_x86/64/ImmortalWrt/25.12/generic', extraFiles = [] } = {}) {
  ...
  return spawnSync(process.execPath, [TOOL], {
    encoding: 'utf8',
    env: { ...process.env, REQUEST_MANIFEST: manifestPath, ISSUE_TITLE: title },
  });
}
